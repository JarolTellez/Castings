...
public class PanelPerfil extends javax.swing.JPanel {
    ...
    public void limpiarCampos() {
        ...
        cbbExperiencia.setSelectedIndex(0);
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(174, 198, 207));
        ...
        jPanel1.add(opFemenino, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, -1, -1));

        grupoSexo.add(opMasculino);
        opMasculino.setText("Masculino");
        jPanel1.add(opMasculino, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, -1, -1));
    ...
    private void RegistrarPerfil() {
        String colorOjos = txtColorOjos.getText().trim();
        String colorPelo = txtColorPelo.getText().trim();
        String Sexo = null;

        if (opFemenino.isSelected()) {
            Sexo = opFemenino.getText();
        } else if (opMasculino.isSelected()) {
            Sexo = opMasculino.getText();
        }

        if (colorOjos.isEmpty() || colorPelo.isEmpty()) {
        ...
        if (colorOjos.isEmpty() || colorPelo.isEmpty() || altura.isEmpty() || Estado.isEmpty()
                || edad.isEmpty() || especialidad.equals(null) || especialidad.isEmpty() || experiencia.equals(null)
                || Sexo.equals(null) || Sexo.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Debe llenar toda la informacion solicitada. \n No deje espacios en blanco u opciones sin seleccionar.", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
